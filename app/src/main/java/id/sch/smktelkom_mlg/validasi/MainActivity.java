package id.sch.smktelkom_mlg.validasi;
        ...
        public void onClick(View v) {
            ...
            private boolean isValid() {
                ...
                if (tahun.isEmpty()){
                    ...
                    edittahun.setError("Format tahun yyy"); valid = false;
                }
                else{
                    edittahun.setError(null);
                }
                if (alamat.isEmpty()){
                    editalamat.setError("Alamat Belum Diisi"); valid = false;
                }
                else if (alamat.length()<4){
                    editalamat.setError("Karakter kurang dari 4"); valid = false;
                }
                else{
